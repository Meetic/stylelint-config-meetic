...
// Stylelint uses require-from-string library, which
// seems to be unable to require modules that require
// other modules, so we have to combine rules, rule
// properties order, and the configuration object
// into this single file.
//
// Stylelint also doesn't support Babel 6 default exports,
